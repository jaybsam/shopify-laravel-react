      ...
      <Stack wrap={false}>
        ...
        <Stack.Item fill>
          <Layout>
            ...
            <Layout.Section>
              <h1 style={{fontWeight: "bold"}}>Filter Products</h1>
              <br/>
            </Layout.Section>
                ...
                <Layout>
                  ...
                  <Layout.Section>
                    <ButtonGroup>
                     ...
                     <Button primary>FILTER PRODUCTS</Button>
                      </ButtonGroup>
                    </Layout.Section>
            ...
            <Layout.Section>
             <h1 style={{fontWeight: "bold"}}>PREVIEW PRODUCTS</h1>
              <br/> 
            </Layout.Section>
            <Layout.Section>
              <Card>
            ...
            <Layout.Section>
             <h1 style={{fontWeight: "bold"}}>EDIT VARIANTS</h1>
              <br/> 
            </Layout.Section>
            <Layout.Section>
              <Card>
